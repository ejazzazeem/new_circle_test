...
@Component({
  selector: 'app-participating-providers',
  templateUrl: './participating-providers.component.html',
  styleUrls: ['./participating-providers.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ParticipatingProvidersComponent implements OnInit, OnDestroy {
  ...
  getResults() {
    this.reportingService.getPagedParticipatingProviders(this.paginationObj.currentOffSet,  this.paginationObj.pageSize).takeUntil(this.unSubscribe).subscribe(
        data => {
